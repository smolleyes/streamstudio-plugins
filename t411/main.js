                ...
                if(t411.gui.settings.t411Username && t411.gui.settings.t411Password) {
                    ...
                    .done(function(data){
                        if ($('a:contains("Déconnexion")',data).length == 0) {
                            ...
                            t411.notif({
                                ...
                                cls: 'red',
                                icon: '&#59256;',
                                content: _("t411.ai connexion problem ! :  Invalid username or password..."),
                                btnId: '',
                                btnTitle: '',
                                btnColor: '',
                                btnDisplay: 'none',
                            ...
                            t411.notif({
                                ...
                                cls: 'green',
                                icon: '&#10003;',
                                content: _("t411.ai connexion ok !"),
                                btnId: '',
                                btnTitle: '',
                                btnColor: '',
                                btnDisplay: 'none',
                    ...
                    .fail(function(error) {
                        ...
                        t411.notif({
                            ...
                            cls: 'red',
                            icon: '&#59256;',
                            content: _("t411.ai connexion problem ! : "+ error),
                            btnId: '',
                            btnTitle: '',
                            btnColor: '',
                            btnDisplay: 'none',
                ...
                $.get('http://irc.t411.ai/ip/index.php',function(res) {
                    ...
                    if(state == "ON-LINE") {
                        t411.notif({
                            ...
                            cls: 'green',
                            icon: '&#10003;',
                            content: _("t411.ai Tracker ON-LINE !"),
                            btnId: '',
                            btnTitle: '',
                            btnColor: '',
                            btnDisplay: 'none',
                        ...
                        t411.notif({
                            ...
                            cls: 'red',
                            icon: '&#59256;',
                            content: _("t411.ai Tracker DOWN !"),
                            btnId: '',
                            btnTitle: '',
                            btnColor: '',
                            btnDisplay: 'none',
